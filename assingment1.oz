...
{Browse {ZipWith Add [1 2 3 4] [5 6 7 8]}}
...
{Browse {FoldL Subtract [1 2 3 4] 0}}
...
% Just a checking function for Taylor
fun {Sine X N}
    local
        fun {Addup Xs S N}
            if N==0 then S
...
{Browse {Sine 0.523598775598298873 1000}}
...
{Browse {Approximate {Taylor 0.52} 0.0001}}
...
{Browse {IsDiagonal [[1 0 0] [0 1 0] [0 0 1]]}}